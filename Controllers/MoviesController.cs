...
namespace MoviePro.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public MoviesController(IOptions<AppSettings> appSettings, ApplicationDbContext context, IImageService imageService = null, IRemoteMovieService tmdbMovieService = null, IDataMappingService tmdbMappingService = null)
        {
        ...
        public async Task<IActionResult> Import(int id)
        {
            ...
            if (_context.Movie.Any(m => m.MovieId == id))  // go out to the database, go out to the movie table and if find any records who's MovieId == to incoming id
            {
                // redirect the user to the movieDetails page for that movie thats already been imported
        ...
        {
            var movies = await _context.Movie.ToListAsync();  // go out to the database and get all the movies
            return View(movies);  // seed the view with the data
        }
        ...
        public async Task<IActionResult> Details(int? id, bool local = false)
        {
            ...
            {
                //Get tge movie data from the TMDB API
        ...
        public async Task AddToMovieCollection(int movieId, string collectionName)
        {
        ...
        public async Task AddToMovieCollection(int movieId, int collectionId)
        {
            _context.Add(
                new MovieCollection()
                {
